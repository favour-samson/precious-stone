    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-96 bg-gradient-to-r from-gray-900 to-gray-800 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xl text-gray-200">Don't miss out on what's happening at RCCG Precious Stone Parish (Area Headquarters)</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-secondary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            Subscribe to our event notifications and stay updated on all activities at RCCG Precious Stone Parish (Area Headquarters).
          </p>
